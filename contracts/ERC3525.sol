...
import "@solvprotocol/erc-3525/IERC721.sol";
import "@solvprotocol/erc-3525/IERC3525.sol";
import "@solvprotocol/erc-3525/IERC721Receiver.sol";
import "@solvprotocol/erc-3525/IERC3525Receiver.sol";
import "@solvprotocol/erc-3525/extensions/IERC721Enumerable.sol";
import "@solvprotocol/erc-3525/extensions/IERC721Metadata.sol";
...
contract ERC3525 is Context, IERC3525Metadata, IERC721Enumerable {
    ...
    function ownerOf(uint256 tokenId_) public view virtual override returns (address owner_) {
        ...
        require(owner_ != address(0), Errors.INVALID_TOKEN_ID);
    }
    ...
    function approve(uint256 tokenId_, address to_, uint256 value_) public payable virtual override {
        ...
        require(to_ != owner, Errors.APPROVE_TO_OWNER);
    ...
    function transferFrom(
        ...
        newTokenId = _mint(to_, ERC3525.slotOf(fromTokenId_), 0);
    ...
    function balanceOf(address owner_) public view virtual override returns (uint256 balance) {
        ...
        require(owner_ != address(0), Errors.ZERO_ADDRESS);
    ...
    function tokenByIndex(uint256 index_) public view virtual override returns (uint256) {
        ...
        require(index_ < ERC3525.totalSupply(), Errors.INDEX_EXCEEDS);
    ...
    function tokenOfOwnerByIndex(address owner_, uint256 index_) public view virtual override returns (uint256) {
        ...
        require(index_ < ERC3525.balanceOf(owner_), Errors.INDEX_EXCEEDS);
    ...
    function _setApprovalForAll(
        ...
        require(owner_ != operator_, Errors.APPROVE_TO_CALLER);
    ...
    function _spendAllowance(address operator_, uint256 tokenId_, uint256 value_) internal virtual {
        ...
        if (!_isApprovedOrOwner(operator_, tokenId_) && currentAllowance != type(uint256).max) {
            ...
            require(currentAllowance >= value_, Errors.INSUFFICIENT_ALLOWANCE);
    ...
    //     require(tokenId_ != 0, Errors.INVALID_TOKEN_ID);
    //     // require(!_exists(tokenId_), "ERC3525: token already minted");
    //     require(!_exists(tokenId_), Errors.TOKEN_ALREADY_MINTED);
    ...
    function _transferValue(
        ...
        require(_exists(fromTokenId_), Errors.INVALID_TOKEN_ID);
        // require(_exists(toTokenId_), "ERC3525: transfer to invalid token ID");
        require(_exists(toTokenId_), Errors.INVALID_TOKEN_ID);
        ...
        require(fromTokenData.balance >= value_, Errors.INSUFFICIENT_BALANCE);
        // require(fromTokenData.slot == toTokenData.slot, "ERC3525: transfer to token with different slot");
        require(fromTokenData.slot == toTokenData.slot, Errors.CROSS_SLOT);
    ...
    function _transferTokenId(
        ...
        require(ERC3525.ownerOf(tokenId_) == from_, Errors.NOT_OWNER);
    ...
    function _checkOnERC721Received(
        ...
        if (to_.isContract()) {
            try 
                ...
                if (reason.length == 0) {
                    revert(Errors.NON_ERC721RECEIVER);
                } else {
